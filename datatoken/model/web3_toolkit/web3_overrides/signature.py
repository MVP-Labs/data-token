...
from alaya.packages.platon_keys.datatypes import Signature
from alaya.packages.platon_keys.utils.numeric import int_to_byte
from alaya.packages.platon_keys.utils.padding import pad32
from alaya.packages.eth_utils import int_to_big_endian
...
class SignatureFix(Signature):
    ...
    def to_hex_v_hacked(self) -> str:
        ...
        return '0x' + codecs.decode(codecs.encode(self.to_bytes_v_hacked(), 'hex'),
                                    'ascii')  # type: ignore
